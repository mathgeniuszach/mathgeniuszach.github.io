    ...
    "data": {
        ...
        "origins:health": {
            "comparison": {
                "name": "Comparison",
                "type": "options",
                "desc": "How the health of the player should be compared to the specified value.",
                "options": ["<", ">", ">=", "<=", "=="]
            },
            "compare_to": {
                "name": "Health",
    ...
    "data": {
        ...
        "origins:execute_command": {
            ...
            "permission_level": {
                ...
                "type": "int",
                "desc": 'The permission level to use for the command. 0 is a "survival player", anything higher emulates some form of operator. See Minecraft Wiki (op-permission-level) for details.',
                "default": 4
            }
        },
